...
import { paletteBase as palette } from "./palette";

const MODE = palette.grey[500];
...
export const customShadows = createCustomShadow(MODE);

const shadows = createShadow(MODE);
